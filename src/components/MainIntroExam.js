...
export default function MaingInto() {
    return (
        <MainIntroduction>
            <br/>
            <IntroTitle>
                <StepNumberStyle>시험지 제작소</StepNumberStyle>
                <Step> 문제들을 조합하여 
                    나만의 시험지를 제작할 수 있어요! </Step>
                <p style={{fontWeight : "600", fontSize:"21px", marginTop: "35px", marginBottom:"5px"}}>현재 제공되는 시험지 문제</p>
                <p style={{color : "#9A9DA0", fontSize:"14px", fontWeight: "500", marginTop:"0px", marginBottom: "0px"}}>*향후에는 다양한 종류의 시험지 문제가 추가될 예정입니다. </p>
            ...
            <IntroBody>
                ...
                <StepIntroContent>
                    ...
                    <SelectIntroImg src="./img/Intro_문제검색설명.svg" alt="문제 검색 설명 Image" />
                </StepIntroContent>
                <StepIntroContent>
                    <StepIntroText>
                    ...
                    <PDFIntroImg src="./img/Intro_PDF저장사진.svg" alt="PDF 저장 Image" />
                </StepIntroContent>
